$(document).ready(function () {
    ...
    function rsvp(coming) {
        ...
        if (MD5($('#invite_code').val()) !== '6e746846ad849391755c57db7166827c') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbyPrWqSgI5GtAdPmv7_s5BqgFKZs4grEv0WiVrh-yUlEC4Z8fk/exec', data)
                .done(function (data) {
                    console.log(data);
                    $('#alert-wrapper').html('');
                    if (coming) {
...
// Google map
function initMap() {
    var itc_kol = {lat: 35.862027, lng: -83.586533};
